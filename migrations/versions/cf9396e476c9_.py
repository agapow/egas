...
Revision ID: cf9396e476c9
Revises: 73a811e5c91a
Create Date: 2017-07-10 13:10:29.243604
...
revision = 'cf9396e476c9'
down_revision = '73a811e5c91a'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.create_table('set_membership',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('assoc_id', sa.VARCHAR(length=48), nullable=True),
    sa.Column('set_id', sa.INTEGER(), nullable=True),
    sa.ForeignKeyConstraint(['assoc_id'], ['associations.id'], ),
