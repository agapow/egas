...
Revision ID: 5fe92cb86490
Revises: d1d9475f40ce
Create Date: 2017-06-30 16:23:23.266040
...
revision = '5fe92cb86490'
down_revision = 'd1d9475f40ce'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.UniqueConstraint('snp_id', 'cpg_id')
    )
