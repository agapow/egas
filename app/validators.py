...
class NotEqualTo (object):
    ...
    :param message:
        ...
        interpolated with `%(other_label)s` and `%(other_name)s` to provide a more helpful error.
    """
    ...
    def __call__(self, form, field):
        try:
            ...
            raise wtfval.ValidationError (field.gettext("Invalid field name '%s'.") % self.fieldname)
